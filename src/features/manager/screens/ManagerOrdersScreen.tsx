...
} from '@manager/api/managerOrderApi';
import { OrderStatusBadge } from '@manager/components/OrderStatusBadge';
import {
  useManagerOrdersList,
  useManagerStatusCounts,
} from '@manager/hooks/useManagerOrders';
...
export const ManagerOrdersScreen = (): React.JSX.Element => {
  ...
  const { items, isLoading, isRefreshing, isLoadingMore, hasNext, loadMore, refresh } =
